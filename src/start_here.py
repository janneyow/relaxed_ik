...
info_file_name = 'xarm6_info.yaml'
######################################################################################################
...
joint_names = [ ['joint1', 'joint2', 'joint3', 'joint4', 'joint5', 'joint6', 'joint_eef', 'gripper_fix', 'drive_joint', 'left_finger_joint', 'left_inner_knuckle_joint', 'right_outer_knuckle_joint', 'right_finger_joint', 'right_inner_knuckle_joint', 'joint_tcp'] ]
######################################################################################################
...
joint_ordering =  ['joint1', 'joint2', 'joint3', 'joint4', 'joint5', 'joint6', 'drive_joint', 'left_finger_joint', 'left_inner_knuckle_joint', 'right_outer_knuckle_joint', 'right_finger_joint', 'right_inner_knuckle_joint']
######################################################################################################
...
ee_fixed_joints = ['joint_eef', 'gripper_fix', 'joint_tcp' ]
######################################################################################################
...
starting_config = [0.0000, 0.0000, 0.0000, 0.0000, -1.5708, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000]
######################################################################################################
...
collision_file_name = 'collision_xarm6.yaml'
###########################################################################################################
